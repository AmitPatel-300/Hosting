				...
				<div class="footer-section">
					<div class="container">
						<div class="footer-grids">
							...
							<div class="col-md-3 footer-grid">
								<h4>get in touch</h4>
								<p>Software Company 3/460,Opposite</p>
								<p>Opp to Nehru Enclave</p>
								<p>Vishwas Khand,lucknow</p>
								<p>UttarPradesh/+91 5224077802</p>
								<p>E-mail : <a href="mailto:info@cedcoss.com"> info@cedcoss.com</a></p>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="copy-section">
							<p>&copy; 2020 Ced Hosting. All rights reserved | Design by <a href="http://w3layouts.com">Cedcoss pvt. Ltd.</a></p>
						</div>
					</div>
				</div>
			<!---footer--->