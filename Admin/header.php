...
<head>
  ...
  <title>Ced Hosting Dashboard - Free Dashboard for Bootstrap 4</title>
  <!-- Favicon -->
  ...
  <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="assets/img/brand/ced.png" class="navbar-brand-img" alt="...">
        </a>
      </div>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link"  href="#page6" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle abc">
                <i class="ni ni-circle-08 text-pink text-info"></i>
            ...
            <li class="nav-item" >
            <a class="nav-link" href="usercompleteride.php">Change Security Ques</a>
            </li>
            <li class="nav-item">
            <a  class="nav-link" href="userallrides.php">Change Password</a>
            </li>
            </ul>
            </li>
                ...
                <div class="list-group list-group-flush">
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="assets/img/theme/Admin.jpeg" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
